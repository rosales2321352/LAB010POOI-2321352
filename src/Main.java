...
public class Main {
    public static void main(String[] args) {
        ...
        List<EstudianteUniversitario> estudianteUniversitarioList = Arrays.asList(
                new EstudianteUniversitario("Juan Ramon","Marti Mateu",65,"Ing. Software",new Direccion("07764","Pasaje San Isidro 75","Madrid","Navarra"),Arrays.asList(new NumeroCelular("652306669"),new NumeroCelular("652306669"))),
                ...
                new EstudianteUniversitario("Eugenia","Guerrero Carrasco",36,"Ing. Software",new Direccion("92138","Corredera Fuente 296","A coruña","Barcelona"),Arrays.asList(new NumeroCelular("699114381"),new NumeroCelular("699114381"))),
                ...
                new EstudianteUniversitario("Javier","Contreras Vela",81,"Diseño Grafico",new Direccion("09769","Carrera Manuel de Falla 22","Cáceres","Tarragona"),Arrays.asList(new NumeroCelular("625008468"),new NumeroCelular("625008468"))),
                new EstudianteUniversitario("Olivia","Jimenez Cruz",55,"Diseño Grafico",new Direccion("55016","Ronda Rafael Murillo 881","Melilla","Sevilla"),Arrays.asList(new NumeroCelular("601788984"),new NumeroCelular("601788984"))),
                new EstudianteUniversitario("Luis Maria","Cano Tomas",21,"Ing. Industrial",new Direccion("73456","Travesía Miguel de Cervantes 623","Navarra","Rioja, La"),Arrays.asList(new NumeroCelular("666732606"),new NumeroCelular("666732606"))),
